...
model (:class:`ValidationResult`, :class:`MutationResult`, or
:class:`SinkResult`); the hosting side stamps the common wire fields
(`interceptor`, `phase`, `durationMs`) on it before returning it to the
invoker.
"""
